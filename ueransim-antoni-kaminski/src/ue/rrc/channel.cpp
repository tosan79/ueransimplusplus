...
void UeRrcTask::receiveRrcMessage(int cellId, ASN_RRC_BCCH_DL_SCH_Message *msg)
{
    ...
    case ASN_RRC_BCCH_DL_SCH_MessageType__c1_PR_systemInformationBlockType1:
        ...
        break;
    case ASN_RRC_BCCH_DL_SCH_MessageType__c1_PR_systemInformation:
        receiveSib2(cellId, *c1->choice.systemInformation->criticalExtensions.choice.systemInformation->sib_TypeAndInfo.list.array[0]->choice.sib2);
    default:
        break;
    }
}
