...
Json ToJson(const Sib1Config &v) {
    return Json::Obj({
        {"q_RxLevMin", v.q_RxLevMin},
        {"q_RxLevMinOffset", *v.q_RxLevMinOffset},
        {"q_RxLevMinSUL", *v.q_RxLevMinSUL},
        {"q_QualMin", *v.q_QualMin},
        {"q_QualMinOffset", *v.q_QualMinOffset},
    });
}

Json ToJson(const Sib2Config &v) {
    return Json::Obj({
        {"q_Hyst", v.q_Hyst},
        {"treshServingLowP", v.treshServingLowP},
        {"cellReselectionPriority", v.cellReselectionPriority},
        {"q_RxLevMin", v.q_RxLevMin},
        {"s_IntraSearchP", v.s_IntraSearchP},
        {"s_IntraSearchQ", *v.s_IntraSearchQ},
        {"t_ReselectionNR", v.t_ReselectionNR},
        {"deriveSSB_IndexFromCell", v.deriveSSB_IndexFromCell},
    });
}
...
Json ToJson(const GnbConfig &v)
{
    return Json::Obj({
        ...
        {"intraFreqReselectionAllowed", v.intraFreqReselectionAllowed},
        {"cellSelectionInfo", ToJson(v.sib1conf)},
        {"cellReselectionInfo", ToJson(v.sib2conf)},
    });
}
