...
struct Sib1Config {
    long q_RxLevMin;
    std::optional<long> q_RxLevMinOffset;
    std::optional<long> q_RxLevMinSUL;
    std::optional<long> q_QualMin;
    std::optional<long> q_QualMinOffset;
};

struct Sib2Config {
    long q_Hyst;
    long treshServingLowP;
    long cellReselectionPriority;
    long q_RxLevMin;
    long s_IntraSearchP;
    std::optional<long> s_IntraSearchQ;
