...
static nr::gnb::GnbConfig *ReadConfigYaml()
{
    ...
    result->intraFreqReselectionAllowed = yaml::GetBool(config, "intraFreqReselectionAllowed");

    yaml::AssertHasField(config, "cellSelectionInfo");
    result->sib1conf.q_RxLevMin = yaml::GetInt32(config["cellSelectionInfo"], "q_RxLevMin");
    result->sib1conf.q_RxLevMinOffset = yaml::GetInt32(config["cellSelectionInfo"], "q_RxLevMinOffset");
    result->sib1conf.q_RxLevMinSUL = yaml::GetInt32(config["cellSelectionInfo"], "q_RxLevMinSUL");
    result->sib1conf.q_QualMin = yaml::GetInt32(config["cellSelectionInfo"], "q_QualMin");
    result->sib1conf.q_QualMinOffset = yaml::GetInt32(config["cellSelectionInfo"], "q_QualMinOffset");

    yaml::AssertHasField(config, "cellReselectionInfo");
    result->sib2conf.q_Hyst = yaml::GetInt32(config["cellReselectionInfo"], "q_Hyst");
    result->sib2conf.treshServingLowP = yaml::GetInt32(config["cellReselectionInfo"], "treshServingLowP");
    result->sib2conf.cellReselectionPriority = yaml::GetInt32(config["cellReselectionInfo"], "cellReselectionPriority");
    result->sib2conf.q_RxLevMin = yaml::GetInt32(config["cellReselectionInfo"], "q_RxLevMin");
    result->sib2conf.s_IntraSearchP = yaml::GetInt32(config["cellReselectionInfo"], "s_IntraSearchP");
    result->sib2conf.s_IntraSearchQ = yaml::GetInt32(config["cellReselectionInfo"], "s_IntraSearchQ");
    result->sib2conf.t_ReselectionNR = yaml::GetInt32(config["cellReselectionInfo"], "t_ReselectionNR");
    result->sib2conf.deriveSSB_IndexFromCell = yaml::GetBool(config["cellReselectionInfo"], "deriveSSB_IndexFromCell");
